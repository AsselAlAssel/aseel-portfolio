...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="hero-section relative min-h-screen overflow-hidden pb-12 lg:pb-16"
    ...
    >
      ...
      <Container
        size="wide"
        className="relative grid min-h-screen items-center gap-6 lg:grid-cols-[0.9fr_1.1fr]"
      >
        <div>
          <HeroContent />
        </div>
        <m.div style={{ y: visualY, opacity: visualOpacity }}>
          <HeroVisual />
        </m.div>
      </Container>
      <m.div
